...
hal::bsp_pins!(
    ...
    /// GPIO 23 is connected to b_power_save of the Picoboy.
    Gpio23 {
        name: b_power_save,
    },

    /// GPIO 24 is connected to vbus_detect of the Picoboy.
    Gpio24 {
        name: vbus_detect,
    },
    ...
    /// GPIO 29 is connected to voltage_monitor of the Picoboy.
    Gpio29 {
